...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AJ: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      AK: x0 => x0.beta,
      AL: x0 => x0.convertToBlob(),
      AM: (x0,x1) => { x0.playbackRate = x1 },
      ...
      BI: (map, o) => map.get(o),
      BJ: (x0,x1) => globalThis.fetch(x0,x1),
      BK: x0 => x0.alpha,
      BL: (x0,x1,x2) => new ImageData(x0,x1,x2),
      BM: (x0,x1) => { x0.loop = x1 },
      ...
      CL: (x0,x1) => x0.getContext(x1),
      CM: (x0,x1) => { x0.crossOrigin = x1 },
      ...
      DJ: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1,x2) { return wasmFunction(f,arguments.length,x0,x1,x2) }),
      DK: x0 => x0.gamma,
      DL: (x0,x1) => new OffscreenCanvas(x0,x1),
      DM: (x0,x1) => { x0.preload = x1 },
      E: (exn) => {
      ...
      EI: x0 => x0.deref(),
      EJ: (x0,x1) => x0.forEach(x1),
      EK: x0 => x0.beta,
      EL: x0 => x0.allocationSize(),
      EM: (x0,x1) => x0.createElement(x1),
      F: () => new Error().stack,
      ...
      GJ: x0 => x0.statusText,
      GK: x0 => x0.rotationRate,
      GL: (x0,x1) => { x0.height = x1 },
      GM: x0 => x0.length,
      ...
      HJ: x0 => x0.url,
      HK: x0 => x0.acceleration,
      HL: (x0,x1) => { x0.width = x1 },
      HM: x0 => x0.getReader(),
      ...
      JJ: x0 => x0.cancel(),
      JK: x0 => x0.y,
      JL: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      JM: x0 => x0.done,
      K: (exn) => {
      ...
      LI: x0 => x0.pressed,
      LJ: x0 => x0.read(),
      LK: x0 => x0.accelerationIncludingGravity,
      LL: x0 => x0.format,
      LM: x0 => x0.body,
      M: o => String(o),
      MB: (o, p) => o[p],
      ...
      NI: x0 => x0.buttons,
      NJ: x0 => x0.done,
      NK: (x0,x1) => globalThis.Reflect.construct(x0,x1),
      NL: x0 => x0.canvasKitMaximumSurfaces,
      NM: x0 => x0.loader,
      ...
      OL: x0 => x0.debugSkipFontRetryDelay,
      ...
      RI: () => globalThis.navigator,
      RJ: (x0,x1) => x0.getRandomValues(x1),
      RK: x0 => x0.stop(),
      RL: x0 => x0.location,
      ...
      SH: x0 => x0.first(),
      SI: (x0,x1,x2) => x0.setItem(x1,x2),
      SJ: () => globalThis.crypto,
      SK: x0 => x0.message,
      SL: (x0,x1) => x0.getModifierState(x1),
      T: x0 => new Promise(x0),
      ...
      TJ: l => new DataView(new ArrayBuffer(l)),
      TK: x0 => x0.name,
      TL: x0 => x0.metaKey,
      ...
      bJ: x0 => x0.now(),
      bK: x0 => x0.RelativeOrientationSensor,
      bL: x0 => x0.disconnect(),
      c: o => o,
      cB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cJ: () => globalThis.performance,
      cK: x0 => x0.AbsoluteOrientationSensor,
      cL: x0 => x0.remove(),
      d: (o, p) => o[p],
      ...
      dJ: x0 => x0.charging,
      dK: x0 => x0.Magnetometer,
      dL: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      e: () => globalThis,
      eB: o => {
        if (o === null || o === undefined) return 0;
      ...
      gJ: x0 => x0.getBattery,
      gK: x0 => x0.LinearAccelerationSensor,
      ...
      hJ: () => globalThis.navigator,
      hK: x0 => x0.Accelerometer,
      hL: (x0,x1) => { x0.value = x1 },
      i: (l, r) => l === r,
      ...
      iK: x0 => x0.DeviceOrientationEvent,
      iL: x0 => x0.gain,
      j: x0 => x0.random(),
      ...
      kJ: x0 => ({enableHighAccuracy: x0}),
      kK: x0 => x0.requestPermission(),
      kL: x0 => x0.play(),
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      lH: () => new TextDecoder(),
      lI: x0 => x0.frameCount,
      lJ: (x0,x1,x2,x3) => x0.watchPosition(x1,x2,x3),
      lK: x0 => x0.requestPermission,
      lL: (x0,x1) => { x0.currentTime = x1 },
      m: () => globalThis.Math,
      ...
      oJ: x0 => x0.code,
      oK: x0 => x0.state,
      oL: (x0,x1) => x0.createMediaElementSource(x1),
      p: b => !!b,
      ...
      qI: x0 => x0.close(),
      qJ: x0 => x0.speed,
      qK: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      qL: x0 => x0.createStereoPanner(),
      r: (x0,x1) => x0.focus(x1),
      ...
      rJ: x0 => x0.accuracy,
      rK: x0 => x0.arrayBuffer(),
      rL: (x0,x1) => x0.connect(x1),
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
      ...
      yL: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
