...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      JG: x0 => x0.index,
      JH: x0 => x0.content,
      JI: (handle) => clearInterval(handle),
      JJ: x0 => x0.status,
      JK: x0 => x0.remove(),
      K: (exn) => {
      ...
      SH: x0 => x0.first(),
      SI: () => globalThis.navigator,
      SJ: (x0,x1) => x0.getRandomValues(x1),
      SK: (x0,x1) => { x0.currentTime = x1 },
      T: x0 => new Promise(x0),
      ...
      VJ: (x0,x1) => x0.getItem(x1),
      VK: (x0,x1) => x0.createMediaElementSource(x1),
      W: x0 => new Array(x0),
      ...
      YJ: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      YK: (x0,x1) => x0.connect(x1),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      aJ: (x0,x1) => x0.transferFromImageBitmap(x1),
      aK: x0 => x0.destination,
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      jJ: (x0,x1,x2) => new ImageData(x0,x1,x2),
      ...
      rH: x0 => x0.disabled,
      rI: x0 => x0.close(),
      rJ: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      rK: x0 => x0.read(),
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
      ...
      vJ: x0 => x0.debugSkipFontRetryDelay,
